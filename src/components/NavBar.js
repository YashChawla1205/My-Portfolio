...
import  {TwitterIcon, HackerRank, GithubIcon, LinkedInIcon, LeetCodeIcon, SunIcon, MoonIcon } from './Icons';
...
const NavBar = () => {
  ...
  return (
    ...
    <button className='flex-col justify-center items-center hidden lg:flex' onClick={handleClick}>
      ...
      <span className={`bg-dark dark:bg-light transition-all duration-300 ease-out block h-0.5 w-6 rounded-sm  my-0.5 ${isOpen ? "-rotate-45 -translate-y-0.4":"-translate-y-0.5"}`}></span>
      <span className={`bg-dark dark:bg-light transition-all duration-300 ease-out block h-0.5 w-6 rounded-sm  ${isOpen ? "-rotate-45 -translate-y-1": "-translate-y-0.5"}`}></span>
    </button>
      ...
      <nav className='flex items-center justify-center flex-wrap'>
        <motion.a href="https://x.com/YashChawla78538" target={"_blank"}
        whileHover={{y:-2}}
        whileTap={{scale:0.9}}
        className='w-6 mx-3'
        >
        ...
        <motion.a href="https://github.com/YashChawla1205" target={"_blank"}
        whileHover={{y:-2}}
        whileTap={{scale:0.9}}
        className='w-6 mx-3'
        >
        ...
        <motion.a href="https://www.linkedin.com/in/yash-chawla-705b74231/" target={"_blank"}
        whileHover={{y:-2}}
        whileTap={{scale:0.9}}
        className='w-6 mx-3'
        >
        ...
        <motion.a href="https://leetcode.com/u/yashchawla1205/" target={"_blank"}
        whileHover={{y:-2}}
        whileTap={{scale:0.9}}
        className='w-6 mx-3 dark:bg-light rounded'
        >
          <LeetCodeIcon/>
        </motion.a>
        <motion.a href="https://www.hackerrank.com/profile/yashchawla1205" target={"_blank"}
        whileHover={{y:-2}}
        whileTap={{scale:0.9}}
        className='w-6 ml-3'
        >
...
className=' min-w-[70vw] flex flex-col justify-between items-center z-30 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'>
      ...
      <nav className='flex items-center justify-center flex-wrap mt-2'>
        ...
        whileHover={{y:-2}}
        whileTap={{scale:0.9}}
        className='w-6 mx-3 dark:bg-light rounded sm:mx-1'
        >
          <LeetCodeIcon/>
        </motion.a>
        ...
        whileHover={{y:-2}}
        whileTap={{scale:0.9}}
        className='w-6 ml-3 dark:bg-light rounded-full sm:mx-1'
        >
          <HackerRank/>
        </motion.a>
